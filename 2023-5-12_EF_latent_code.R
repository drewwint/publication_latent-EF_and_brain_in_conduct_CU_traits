...
# Shift
cu_shift <- as.numeric(resid(lm(I(ICUY_TOTAL*swt_pos_all) ~ ICUY_TOTAL + swt_pos_all, data = full_df[is.na(full_df$swt_pos_all)==FALSE])))
full_df$cu_shift <- NA
full_df$cu_shift[which(is.na(full_df$swt_pos_all)==FALSE)] <- cu_shift

cd_shift <- as.numeric(resid(lm(I(YSR_EXTERNALIZING_RAW*swt_pos_all) ~ YSR_EXTERNALIZING_RAW + swt_pos_all, data = full_df[is.na(full_df$swt_pos_all)==FALSE])))
full_df$cd_shift <- NA
full_df$cd_shift[which(is.na(full_df$swt_pos_all)==FALSE)] <- cd_shift


three_shift <- as.numeric(resid(lm(I(ICUY_TOTAL*full_df$cd_shift) ~ ICUY_TOTAL + YSR_EXTERNALIZING_RAW + swt_pos_all+ full_df$cu_shift + full_df$cd_shift, data = full_df[is.na(full_df$swt_pos_all)==FALSE])))
...
# regressions
  # bx data on EFs
inhibit ~ stp_pos_all + ICUY_TOTAL + YSR_EXTERNALIZING_RAW  + sex + tanner + race_w
shift ~ swt_pos_all + ICUY_TOTAL + YSR_EXTERNALIZING_RAW + sex + tanner + race_w 
fluency ~ flu_pos_all + ICUY_TOTAL + YSR_EXTERNALIZING_RAW + sex + tanner + race_w
...
parameterestimates(mod_1_sem, 
                   standardize=TRUE, 
                   rsquare=TRUE, 
                   boot.ci.type = "bca.simple")[c(11:37,250:252),c(1:3,5:6,12,7:10)]

  # Simple Slopes
parameterestimates(mod_1_sem, 
                   standardize=TRUE, 
                   rsquare=TRUE, 
                   boot.ci.type = "bca.simple")[c(235:240),c(1:3,5:6,13,7:10)]
...
cbind(parameterestimates(mod_1_sem, 
                         standardize=TRUE, 
                         rsquare=TRUE, 
                         boot.ci.type = "bca.simple")[c(11:19,235:237,238:240),c(1:3)],
      round(p.adjust(parameterestimates(mod_1_sem, 
                                        standardize=TRUE, 
                                        rsquare=TRUE, 
                                        boot.ci.type = "bca.simple")[c(11:19,235:237,238:240),c(8)],"BH"),3))

    ## Shifting
cbind(parameterestimates(mod_1_sem, 
                         standardize=TRUE, 
                         rsquare=TRUE, 
                         boot.ci.type = "bca.simple")[c(20:28),c(1:3)],
      round(p.adjust(parameterestimates(mod_1_sem, 
                                        standardize=TRUE, 
                                        rsquare=TRUE, 
                                        boot.ci.type = "bca.simple")[c(20:28),c(8)],"BH"),3))

    ## Fluency
cbind(parameterestimates(mod_1_sem, 
                         standardize=TRUE, 
                         rsquare=TRUE, 
                         boot.ci.type = "bca.simple")[c(29:37),c(1:3)],
      round(p.adjust(parameterestimates(mod_1_sem, 
                                        standardize=TRUE, 
                                        rsquare=TRUE, 
                                        boot.ci.type = "bca.simple")[c(29:37),c(8)],"BH"),3))
...
(parameterestimates(mod_1_sem, 
                    standardize=TRUE,
                    rsquare=TRUE)[c(11:16,20:25,29:34),c(12)] - parameterestimates(inital_sem, 
                                                                                   standardize=TRUE, 
                                                                                   rsquare=TRUE)[c(10:27),c(11)])

  # creating an dataframe with all relevant values. 
data.frame(parameterestimates(mod_1_sem, standardize=TRUE, rsquare=TRUE)[c(11:16,20:25,29:34),c(1:3)],
           "delta_std_beta"=round(parameterestimates(mod_1_sem, standardize=TRUE, rsquare=TRUE)[c(11:16,20:25,29:34),c(12)] - parameterestimates(inital_sem, standardize=TRUE, rsquare=TRUE)[c(10:27),c(11)],3),
           "substantial_change"=((parameterestimates(mod_1_sem, standardize=TRUE, rsquare=TRUE)[c(11:16,20:25,29:34),c(12)] - parameterestimates(inital_sem, standardize=TRUE, rsquare=TRUE)[c(10:27),c(11)])>0.10),
           "delta_un_std_beta"=round(parameterestimates(mod_1_sem, standardize=TRUE, rsquare=TRUE)[c(11:16,20:25,29:34),c(5)] - parameterestimates(inital_sem, standardize=TRUE, rsquare=TRUE)[c(10:27),c(4)],3),
           "delta_un_std_ci_low"=round(parameterestimates(mod_1_sem, standardize=TRUE, rsquare=TRUE, boot.ci.type = "bca.simple")[c(11:16,20:25,29:34),c(9)] - parameterestimates(inital_sem, standardize=TRUE, rsquare=TRUE, boot.ci.type = "bca.simple")[c(10:27),c(8)],3),
           "delta_un_std_ci_high"=round(parameterestimates(mod_1_sem, standardize=TRUE, rsquare=TRUE, boot.ci.type = "bca.simple")[c(11:16,20:25,29:34),c(10)] - parameterestimates(inital_sem, standardize=TRUE, rsquare=TRUE, boot.ci.type = "bca.simple")[c(10:27),c(9)],3),
           "delta_std_ci_low"=round(standardizedsolution(mod_1_sem)[c(11:16,20:25,29:34),c(9)] - standardizedsolution(inital_sem)[c(10:27),c(8)],3),
           "delta_dtd_ci_high"=round(standardizedsolution(mod_1_sem)[c(11:16,20:25,29:34),c(10)] - standardizedsolution(inital_sem)[c(10:27),c(9)],3))
...
int_val <- parameterestimates(mod_1_sem, 
                   standardize=TRUE, 
                   rsquare=TRUE, 
                   boot.ci.type = "bca.simple")[c(17:19,26:28,35:37),c(3,12)]
...
for(i in 1:length(int_val$std.all)){
  print(paste(int_val$rhs[i],"power = ", round(pwr::pwr.r.test(r=int_val$std.all[i],n=112,sig.level = 0.05)$power,3)))
    ...
    # "cu_stppos power =    0.915"
    # "cd_stppos power =    0.618"
    # "three_stppos power = 0.460"
    # "cu_shift power =     0.058"
    # "cd_shift power =     0.413"
    # "three_shift power =  0.052"
    # "cu_flu power =       0.588"
    # "cd_flu power =       0.079"
    # "three_flu power =    0.063"
...
EF ~ ICUY_TOTAL + YSR_EXTERNALIZING_RAW + sex + tanner + race_w
...
parameterestimates(explore_sem, 
                   standardize=TRUE, 
                   rsquare=TRUE, 
                   boot.ci.type = "bca.simple")[c(13:29, 259),c(1:3,5:6,12,7:10)]

  # For interaction terms
parameterestimates(explore_sem, 
                   standardize=TRUE, 
                   rsquare=TRUE, 
                   boot.ci.type = "bca.simple")[c(226:246),c(1:3,5:6,13,7:10)]

### fdr corrected p
cbind(parameterestimates(explore_sem, 
                         standardize=TRUE, 
                         rsquare=TRUE, 
                         boot.ci.type = "bca.simple")[c(13:29, 226:246),c(1:3)],
      round(p.adjust(parameterestimates(explore_sem, 
                                        standardize=TRUE, 
                                        rsquare=TRUE, 
                                        boot.ci.type = "bca.simple")[c(13:29, 226:246),c(8)],"fdr"),3))

cbind(parameterestimates(explore_sem, 
                         standardize=TRUE, 
                         rsquare=TRUE, 
                         boot.ci.type = "bca.simple")[c(13:29),c(1:3)],
      round(p.adjust(parameterestimates(explore_sem, 
                                        standardize=TRUE, 
                                        rsquare=TRUE, 
                                        boot.ci.type = "bca.simple")[c(13:29),c(8)],"fdr"),3))


cbind(parameterestimates(explore_sem, 
                         standardize=TRUE, 
                         rsquare=TRUE, 
                         boot.ci.type = "bca.simple")[c(226:246),c(1:3)],
      round(p.adjust(parameterestimates(explore_sem, 
                                        standardize=TRUE, 
                                        rsquare=TRUE, 
                                        boot.ci.type = "bca.simple")[c(226:246),c(8)],"fdr"),3))
...
for(i in 1:length(int_val$std.all)){
  print(paste(int_val$rhs[i],"power = ", round(pwr::pwr.r.test(r=int_val$std.all[i],n=112,sig.level = 0.05)$power,3)))
    ...
    # "cu_stppos power =      0.127"
    # "cd_stppos power =      0.106"
    # "three_stppos power =   0.111"
    # "cu_shift power =       0.09"
    # "cd_shift power =       0.05"
    # "three_shift power =    0.215"
    # "cu_flu power =         0.391"
    # "cd_flu power =         0.066"
    # "three_flu power =      0.065"
...
in_cu <-t(data.frame("inh_cu_vals" = parameterestimates(mod_1_sem, 
                                                        standardize=TRUE, 
                                                        rsquare=TRUE, 
                                                        boot.ci.type = "bca.simple")[c(235:237),c(13)])) # 5  12
...
in_cd <-t(data.frame("inh_cd_vals" = parameterestimates(mod_1_sem,
                                                        standardize=TRUE, 
                                                        rsquare=TRUE, 
                                                        boot.ci.type = "bca.simple")[c(238:240),c(13)])) # 5  12
...
cd1_cu_a <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                        standardize=TRUE, 
                                                        rsquare=TRUE, 
                                                        boot.ci.type = "bca.simple")[c(226:228),c(13)])) 
...
psych::describeBy(c$data, 
                  list(c$data$modx_group,c$data$mod2_group)) 
...
cd1_cu_b <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                           standardize=TRUE, 
                                                           rsquare=TRUE, 
                                                           boot.ci.type = "bca.simple")[c(229:231),c(13)])) 
...
cd1_cu_c <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                           standardize=TRUE, 
                                                           rsquare=TRUE, 
                                                           boot.ci.type = "bca.simple")[c(232:234),c(13)])) 
...
cd2_cu_a <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                           standardize=TRUE, 
                                                           rsquare=TRUE, 
                                                           boot.ci.type = "bca.simple")[c(235:237),c(13)])) 
...
cd2_cu_b <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                           standardize=TRUE, 
                                                           rsquare=TRUE, 
                                                           boot.ci.type = "bca.simple")[c(238:240),c(13)])) 
...
cd2_cu_c <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                           standardize=TRUE, 
                                                           rsquare=TRUE, 
                                                           boot.ci.type = "bca.simple")[c(241:243),c(13)])) 
...
flus <-t(data.frame("inh_cu_vals" = parameterestimates(explore_sem, 
                                                           standardize=TRUE, 
                                                           rsquare=TRUE, 
                                                           boot.ci.type = "bca.simple")[c(244:246),c(13)])) 
